...
export default function ProductActions({ productId, productPrice, productOptions }: ProductActionsProps) {
  ...
  if (isPurchaseModalOpen) {
    return <PurchaseModal productId={productId} productPrice={productPrice} productOptions={productOptions} />;
  }
