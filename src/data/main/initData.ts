...
export const mainCategoryDatas = [
  {
    id: 2,
    title: '텀블러/보온병',
    icon: IconCategoryTumbler.src,
  },
  {
    id: 3,
    title: '머그/컵',
    icon: IconCategryMug.src,
  },
  {
    id: 4,
    title: '라이프스타일',
    icon: IconCategoryLifeStyle.src,
  },
  {
    id: 5,
    title: '티/커피용품',
    icon: IconCategoryTea.src,
  },
  {
    id: 6,
    title: '케이크',
    icon: IconCategoryCake.src,
  },
  {
    id: 7,
    title: '초콜릿/스낵',
    icon: IconCategorySnack.src,
  },
  {
    id: 8,
    title: '세트',
    icon: IconCategorySet.src,
  },
];
